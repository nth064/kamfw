...
set_i18n() {
    ...
    while [ $# -ge 2 ]; do
        ...
        # ç›´æŽ¥å¯¼å‡ºå˜é‡ï¼Œå…è®¸åŒ…å«æ¢è¡Œç¬¦
...
import i18ns
s_index -le # shellcheck shell=ash
##########################################################################################
# KAM Framework - Internationalization (i18n) Module
# Optimized for multi-line text and ash environment (2025 Revised)
##########################################################################################
...
import i18ns
s_lang" in
        ''|*[!A-Za-z0-9_-]*|[0-9]*) unset _s_count _s_index _s_lang; return 2 ;;
        esac
        _s_index=$((_s_index + 2))
    done
    while [ $# -ge 2 ]; do
        ...
        _s_text="$2"
        shift 2
        _s_safe_lang=$(printf '%s' "# shellcheck shell=ash
##########################################################################################
# KAM Framework - Internationalization (i18n) Module
# Optimized for multi-line text and ash environment (2025 Revised)
##########################################################################################
...
import i18ns
s_var_name"="# shellcheck shell=ash
##########################################################################################
# KAM Framework - Internationalization (i18n) Module
# Optimized for multi-line text and ash environment (2025 Revised)
##########################################################################################
...
s_text"
    ...
    unset _s_key _s_lang _s_text _s_safe_lang _s_var_name _s_count _s_index
}
# èŽ·å–å¹¶æ‰“å°å›½é™…åŒ–æ–‡æœ¬
# ç”¨æ³•: i18n "WELCOME_MSG"
i18n() {
